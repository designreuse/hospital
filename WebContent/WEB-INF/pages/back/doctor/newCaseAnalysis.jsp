          ...
          <div class="col-lg-12">
              <div class="ibox float-e-margins">
                  <div class="ibox-content">
                      <form id="caseAnalysisForm" class="form-horizontal" method="post" action="${ctx }/back/doctor/saveCaseAnalysis" enctype="multipart/form-data">
                          <div class="form-group"><label class="col-lg-2 control-label">医生名称：</label>
                              <div class="col-lg-5"><input type="text" name="doctorName"   class="form-control">  
                              </div>
                          </div>
                          ...
                          <div class="form-group"><label class="col-lg-2 control-label">医院：</label>
                              <div class="col-lg-5"><input type="text"  name="hospital" class="form-control">  
                              </div>
                          </div>
                          <div class="form-group"><label class="col-lg-2 control-label">标题：</label>
                              <div class="col-lg-5"><input type="text" name="title"  class="form-control">  
                              </div>
                          </div>
                          <div class="form-group"><label class="col-lg-2 control-label">发布时间：</label>
                              <div class="col-lg-5"><input type="text" name="postTime"  class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">  
                              </div>
                          </div>
                          <div class="form-group"><label class="col-lg-2 control-label">封面图：</label>
                              <div class="col-lg-5"><input type="file" name="imageFile"  class="form-control">  
                              </div>
                          </div>
